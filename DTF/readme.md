...
Note: this is the last version of this mod without [behaviors](https://www.vgm-quiz.com/dev/webliero/extended-behaviors) (v. 27y). If you want to check the further version of the mod (with behaviors, more weapons and other additional cool features), [visit this page](https://gitlab.com/sylvodsds/webliero-extended-mods/-/tree/main/kangur/dtf).
