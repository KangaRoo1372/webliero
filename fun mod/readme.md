...
Roo Fun Mod is generally based on [Scharnvirk's Promode ReRevisited](https://gitlab.com/webliero/webliero-mods/-/tree/master/Jerac/ReRevisited) (version 1.2.0). The mod was made using sprites taken from liero promode final mod (you can also download the sprite file from this repository - file "sprites.wlsprt").
